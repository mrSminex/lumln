...
# Каталог проекта (где лежит этот файл) — все относительные пути файлов БД
# и бэкапов привязаны к нему, а не к текущей рабочей директории процесса.
# Это важно, т.к. systemd может запускать процесс с WorkingDirectory,
# который не совпадает с каталогом проекта.
...
ADMIN_PASSWORD: str = os.getenv("ADMIN_PASSWORD", "lumln")
...
DB_PATH: str = str(BASE_DIR / "lumln.db")
